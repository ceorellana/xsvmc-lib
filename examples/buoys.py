...
buoy_chart = BuoyancyPlot(ifs, 0, test_pics, misvPro_pics, misvCon_pics, zoom=1)
...
buoy_chart.save_plot("test.eps", title="Digit classification - Buoyancy values", version="buoyancy_values", show_legend=False, samples_per_page=3, bar_align='center')